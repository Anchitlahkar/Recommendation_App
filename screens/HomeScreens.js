...
export default class HomeScreen extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      movieDetailsURL: "http://6554-49-37-35-230.ngrok.io",
    };
  }
  ...
  getMovie = () => {
    var { movieDetailsURL } = this.state;
    var url = movieDetailsURL + "/get-movies";
    axios
      .get(url)
      .then((response) => {
  ...
  likedMovie = () => {
    var { movieDetailsURL } = this.state;
    var url = movieDetailsURL + "/liked-movies";
    axios
      .post(url)
      .then((response) => {
        this.getMovie();
  ...
  unlikedMovie = () => {
    var { movieDetailsURL } = this.state;
    var url = movieDetailsURL + "/not-liked-movies";
  ...
  notWatched = () => {
    var { movieDetailsURL } = this.state;
    var url = movieDetailsURL + "/did-not-watch-movies";
    axios
      .post(url)
      .then((response) => {
        this.getMovie();
